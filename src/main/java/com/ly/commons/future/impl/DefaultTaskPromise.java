package com.ly.commons.future.impl;

/**
 * @author: BG320587
 * @date: 2019/5/7 13:47
 */
import com.ly.commons.future.TaskCallback;
import com.ly.commons.future.TaskFuture;
import com.ly.commons.future.TaskPromise;
...
public class DefaultTaskPromise implements TaskPromise {
    ...
    @Override
    public TaskFuture onComplete( TaskCallback callback) {
        if (isDone()) {
